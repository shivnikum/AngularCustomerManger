(function() {
    ...
    var injectParams = ['$scope', '$location', '$routeParams',
        '$timeout', 'config', 'dataService', '$modalInstance'
    ];

    var customerNewEditModelController = function($scope, $location, $routeParams,
        $timeout, config, dataService, $modalInstance) {
        ...
        vm.modalOptions.ok = function(result) {
            //alert("Ok ------- "+vm.customer.firstName);
    ...
    customerNewEditModelController.$inject = injectParams;

    angular.module('customersApp').controller('customerNewEditModelController', customerNewEditModelController);
