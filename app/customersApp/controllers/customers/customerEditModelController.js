(function() {
    ...
    var injectParams = ['$scope', '$location', '$routeParams',
        '$timeout', 'config', 'dataService', '$modalInstance', 'customerObjPopup'
    ];

    var customerEditModelController = function($scope, $location, $routeParams,
        $timeout, config, dataService, $modalInstance, customerObjPopup) {
        ...
        vm.modalOptions.ok = function(result) {
            //alert("Ok Edit ------- "+vm.customer.firstName);
        ...
        function init() {
            getStates().then(function() {
                vm.customer = customerObjPopup;
                //alert("init() ------- "+vm.customer.firstName);
            });
    ...
    customerEditModelController.$inject = injectParams;

    angular.module('customersApp').controller('customerEditModelController', customerEditModelController);
